...
import Etoile from "@/img/Pages/Lodging/Etoile.png";
import EtoileVide from "@/img/Pages/Lodging/EtoileVide.png";
                ...
                ficheLogement ? (
                    <div className="Fiche">
                        ...
                        <div className="description-equipements">
                            <Dropdown title="Description" description={ficheLogement?.description}/>
                            <Dropdown title="Équipements" description={equipementsLogement}/>
                        </div>
                    </div>
